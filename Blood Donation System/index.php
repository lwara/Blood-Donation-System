...
<ul id="menu-top" class="nav navbar-nav navbar-left"> 
        ...
        <div class="content-wrapper" style="margin-top:150px"> 
            <div class="container"> 
                <div class="row"> 
                    <div class="col-md-12"> 
                        <h4 class="page-head-line">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<i class="fa fa-dashboard (alias) fa-3x" style=""></i>Dashboard</h4> 
                    </div>                     
                </div>                 
                <div class="row"> 
                    <div class="col-md-12"> 
                ...
                <div class="row" style="margin-left:200px; margin-right: 1px"> 
                    <div class="col-md-3 col-sm-3 col-xs-6"> 
                        <div class="dashboard-div-wrapper bk-clr-two"> 
                            ...
                            <a href="editHospitalnfo.php?varname=".$var_value style="color:white; text-decoration:none"> <h5><h3>View Hospitals </h3></h5> </a>
                        </div>                         
                    </div>                     
                    <div class="col-md-3 col-sm-3 col-xs-6"> 
                        <div class="dashboard-div-wrapper bk-clr-three"> 
                            ...
                            <a href="addUsers.php?varname=".$var_value style="color:white; text-decoration:none"><h5><h3>Add Users </h3></h5></a> 
                        </div>                         
                    </div>                     
                    <div class="col-md-3 col-sm-3 col-xs-6"> 
                        <div class="dashboard-div-wrapper bk-clr-four"> 
                            ...
                            <a href="editUsers.php?varname=".$var_value style="color:white"> <h5><h3>View Users </h3></h5></a> 
                        </div>                         
                    </div>                     
                </div>                 
                <div class="row"> 

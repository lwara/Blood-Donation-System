...
<a href="piechart.php?varname=".$var_value class="btn btn-primary" role="button" style="background-color:#CC66FF; border-radius:4px"> LINE GRAPH </a> 
<a href="firsthalf.php?varname=".$var_value class="btn btn-primary" role="button" style="background-color:#CC66FF; border-radius:4px"> PIE CHART </a>
              ...
              <div> <img src="../backup/diseasesline.php"></div>

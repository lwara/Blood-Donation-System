...
<ul id="menu-top" class="nav navbar-nav navbar-left"> 
        ...
        <div class="content-wrapper" style="margin-top:150px"> 
            <div class="container"> 
                <div class="row"> 
                    <div class="col-md-12"> 
                        <h1 class="page-head-line">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<i class="fa fa-gears (alias) fa-3x" style="border:solid grey 1px;border-radius:50%;"></i> DISTRIBUTE BLOOD</h1>
                ...
                <div class="row" style="margin-right:150px; margin-left:350px;"> 
                    <div class="col-md-10" style="border-radius:8px"> 
                        <div class="panel panel-default"> 
                            <div class="panel-heading">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; DISTRIBUTE BLOOD</div>                             
                ...
                ?>
                  ...
                  {
                     echo "<option value='".$row3['blood_component_id']."'>".$row3['blood_component']."</option>";
                  }  
                  echo"</select>";
                ?>
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <input type="text"  name="amount" class="form-control" id="exampleInputEmail1" placeholder="Enter Hospital name"/> 
                                    </div>  									
                  ...
                  echo "<select name='patientname' class='form-control select' id ='MBTS_id'  >";
					 echo "<option value=''>"." "."</option>";
                  while($row4 = mysqli_fetch_array($result))
                  {
					 
                     echo "<option value='".$row4['patient_id']."'>".$row4['fname'].$row4['lname']."</option>";
                  }  
                  echo"</select>";
                ?>
 ...
 <div class="form-group"> 
                  ...
                  echo "<select name='diseases' class='form-control select' id ='MBTS_id'  >";
					 echo "<option value=''>"." "."</option>";
                  while($row5 = mysqli_fetch_array($result))
                  {
					 
                     echo "<option value='".$row5['disease_id']."'>".$row5['disease_name']."</option>";
                  }  
                  echo"</select>";
                ?>
...
if(isset($_POST['blood'], $_POST['amount'], $_POST['hospitalname'], $_POST['patientname'], $_POST['diseases'] ) && $rowdd['amount']>500 && $rowdd['amount'] > $_POST['amount'])
{
	
$sql = "INSERT INTO patient_blood_distribution(blood_id,
								amount_of_blood,
								hospital_id,
								patient_id,
								disease_id
...
else if(isset($_POST['blood'], $_POST['amount'], $_POST['hospitalname'], $_POST['patientname'], $_POST['diseases'] ) && $rowdd['amount'] < $_POST['amount'])

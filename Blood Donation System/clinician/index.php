...
<li style="background-color:#4C0000"><a href="accepted.php?varname=".$var_value>VIEW ACCEPTED REQUESTS</a></li>
									<li>
                                    <a class="menu-top-active" href="exportblooddistribution.php?name=".$var_value>EXPORT</a>
                                </li> 
                                   &nbsp;&nbsp;                                
        ...
        <div class="content-wrapper" style="margin-top:150px"> 
            ...
            <div class="container"> 
                ...
                <div class="row" style="margin-left:200px; margin-right: 1px"> 
                    <div class="col-md-3 col-sm-3 col-xs-6"> 
                        <div class="dashboard-div-wrapper bk-clr-two"> 
                            ...
                            <a href="bloodrequest.php?varname=".$var_value style="color:white; text-decoration:none"> <h5><h3>Request Blood </h3></h5> </a>
                        </div>                         
                    </div>                     
                    <div class="col-md-3 col-sm-3 col-xs-6"> 
                        <div class="dashboard-div-wrapper bk-clr-three"> 
                            ...
                            <a href="addUsers.php?varname=".$var_value style="color:white; text-decoration:none"><h5><h3>Generate Graphs</h3></h5></a> 
                        </div>                         
                    </div>                     
                    <div class="col-md-3 col-sm-3 col-xs-6"> 
                        <div class="dashboard-div-wrapper bk-clr-four"> 
                            ...
                            <a href="bloodrequest.php?varname=".$var_value style="color:white"> <h5><h3>Distribute Blood</h3></h5></a> 
                        </div>                         
                    </div>                     
                </div>                 
                <div class="row"> 
